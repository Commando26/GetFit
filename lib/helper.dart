...
if (snapshot.exists){return snapshot;}
  ...
  void writeUserData_steps(int value) {
    getCurrentUser();
    database.reference().child('users/' + loggedinUser.uid + '/steps/steps' ).set(value);
  }
  ...
  void writeUserData_weight_date(final value) {
    getCurrentUser();
    database.reference().child('users/' + loggedinUser.uid + '/weight/date').set(value);
  }
